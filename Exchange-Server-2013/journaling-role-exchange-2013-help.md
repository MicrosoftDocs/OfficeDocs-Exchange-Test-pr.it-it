---
title: "Ruolo dell'inserimento nel journal: Exchange 2013 Help"
TOCTitle: Ruolo dell'inserimento nel journal
ms:assetid: 64608dbe-d4b4-444e-a7df-bc536c4da202
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876894(v=EXCHG.150)
ms:contentKeyID: 50480819
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo dell'inserimento nel journal
...
Il ruolo di gestione `Journaling` consente agli amministratori di creare, modificare, abilitare, disabilitare, visualizzare e rimuovere le regole del journal in un'organizzazione.
