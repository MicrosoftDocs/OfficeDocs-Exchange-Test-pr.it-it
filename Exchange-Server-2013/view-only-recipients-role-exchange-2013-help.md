---
title: 'Ruolo destinatari di sola visualizzazione: Exchange 2013 Help'
TOCTitle: Ruolo destinatari di sola visualizzazione
ms:assetid: 37e66b92-81d3-412f-b7a9-e1bb8cbeb468
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876872(v=EXCHG.150)
ms:contentKeyID: 50480420
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo destinatari di sola visualizzazione
...
Il ruolo di gestione `View-Only Recipients` consente agli amministratori di visualizzare la configurazione dei destinatari, ad esempio, cassette postali, utenti e contatti di posta elettronica, gruppi di distribuzione e gruppi di distribuzione dinamici.

Questo ruolo può essere combinato ai ruoli associati al ruolo `View-Only Configuration` per creare un gruppo di ruoli che può visualizzare ogni oggetto nell'organizzazione. Per ulteriori informazioni, vedere [Ruolo di configurazione di sola visualizzazione](view-only-configuration-role-exchange-2013-help.md).
