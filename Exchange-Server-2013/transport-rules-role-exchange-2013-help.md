---
title: 'Ruolo di regole di trasporto: Exchange 2013 Help'
TOCTitle: Ruolo di regole di trasporto
ms:assetid: 53c5b1a5-e989-4373-ac70-7db16000c645
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876885(v=EXCHG.150)
ms:contentKeyID: 50480609
ms.date: 05/22/2018
...
Il ruolo di gestione `Transport Rules` consente agli amministratori di gestire le regole di trasporto in un'organizzazione.
