---
title: 'Ruolo MyTextMessaging: Exchange 2013 Help'
TOCTitle: Ruolo MyTextMessaging
ms:assetid: 0e030bdb-8a72-4925-bb77-eaca249c36fc
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Ee633454(v=EXCHG.150)
ms:contentKeyID: 50479987
ms.date: 05/22/2018
...
Il ruolo di gestione `MyTextMessaging` consente ai singoli utenti di creare, visualizzare e modificare le impostazioni dei messaggi di testo.
...
<thead>
<tr class="header">
<th>Gruppo di ruoli o criterio di assegnazione</th>
...
<tbody>
<tr class="odd">
<td><p>Criterio predefinito di assegnazione dei ruoli</p>
