---
title: 'Ruolo di migrazione: Exchange 2013 Help'
TOCTitle: Ruolo di migrazione
ms:assetid: 8b5a3385-7dc0-4492-9f00-a4616982016b
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876920(v=EXCHG.150)
ms:contentKeyID: 50481136
ms.date: 05/22/2018
...
Il ruolo di gestione `Migration` consente agli amministratori di spostare le cassette postali e il loro contenuto all'interno o all'esterno di un server.
