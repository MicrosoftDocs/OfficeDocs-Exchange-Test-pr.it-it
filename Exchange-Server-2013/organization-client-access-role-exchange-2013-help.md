---
title: "Ruolo Accesso Client dell'organizzazione: Exchange 2013 Help"
TOCTitle: Ruolo Accesso Client dell'organizzazione
ms:assetid: ff84799a-b79c-498d-b797-7675a4afb1eb
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876962(v=EXCHG.150)
ms:contentKeyID: 50482117
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo Accesso Client dell'organizzazione
...
Il ruolo di gestione `Organization Client Access` consente agli amministratori di gestire le impostazioni del server Accesso client nell'organizzazione.
