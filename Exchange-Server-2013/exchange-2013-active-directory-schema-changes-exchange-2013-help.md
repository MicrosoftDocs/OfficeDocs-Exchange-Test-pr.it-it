---
title: 'Modifiche allo schema di Active Directory in Exchange 2013: Exchange 2013 Help'
TOCTitle: Modifiche allo schema di Active Directory in Exchange 2013
ms:assetid: 7e879e4e-1124-4a41-94d2-c64500beb24e
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Bb738144(v=EXCHG.150)
ms:contentKeyID: 50481048
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Modifiche allo schema di Active Directory in Exchange 2013
...
Gli aggiornamenti dello schema di Exchange 2013 sono cumulativi. Ogni versione include tutte le modifiche incluse nelle versioni precedenti. Ciò significa che se si ignora una versione precedente, potrebbe essere comunque necessario applicare gli aggiornamenti dello schema, anche se la versione che si sta installando non include delle modifiche apportate. Nella tabella seguente vengono forniti alcuni esempi di quando verranno aggiornate Active Directory e già, viene aggiornato.
...
<thead>
<tr class="header">
<th><p>Versione corrente di Exchange 2013 installato</p></th>
<th><p>Nuova versione di Exchange 2013 in fase di installazione</p></th>
<th><p>Sono gli aggiornamenti dello schema necessari?</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p>Service Pack 1</p></td>
<td><p>Aggiornamento cumulativo 11</p></td>
<td><p><strong>Sì</strong>, sono necessari aggiornamenti. Aggiornamenti di schema inclusi in CU5, aggiornamento cumulativo 6 e CU7 devono essere applicati.</p></td>
</tr>
<tr class="even">
<td><p>Aggiornamento cumulativo 6</p></td>
<td><p>Aggiornamento cumulativo 11</p></td>
<td><p><strong>Sì</strong>, sono necessari aggiornamenti. È necessario applicare gli aggiornamenti dello schema inclusi in CU7.</p></td>
</tr>
<tr class="odd">
<td><p>Aggiornamento cumulativo 7</p></td>
<td><p>Aggiornamento cumulativo 11</p></td>
<td><p><strong>No</strong>, non sono necessari aggiornamenti. Non sono state apportate modifiche tra CU7 e CU11.</p></td>
</tr>
</tbody>
</table>
...
> [!NOTE]
> Le modifiche allo schema di Active Directory illustrate in questo argomento potrebbero non essere valide per tutte le edizioni di una versione di Exchange Server.<BR>Per controllare che Active Directory sia stato preparato correttamente, vedere la sezione &amp;quot;Come verificare se l'operazione ha avuto esito positivo&amp;quot; in <A href="prepare-active-directory-and-domains-exchange-2013-help.md">Preparazione di Active Directory e dei domini</A>.



Sono incluse le seguenti sezioni:

  - Active Directory schema le modifiche di aggiornamenti cumulativi di Exchange 2013 CU8 e versioni successive

  - Modifiche allo schema di Active Directory in Exchange 2013 CU7

  - Modifiche allo schema di Active Directory in Exchange 2013 aggiornamento cumulativo 6
...
Non sono state apportate modifiche allo schema Active Directory in Exchange 2013 da CU8 in avanti. L'ultimo aggiornamento cumulativo per includere le modifiche dello schema è attualmente Exchange 2013 CU7.

Aggiornamenti cumulativi futuri possono contenere delle modifiche dello schema. Seleziona qui per ogni versione di aggiornamento cumulativo visualizzare le modifiche dello schema apportate.

## Modifiche allo schema di Active Directory in Exchange 2013 CU7

In questa sezione vengono riepilogate le modifiche apportate allo schema Active Directory quando si installa Exchange 2013 CU7. In questa sezione sono inclusi nelle sottosezioni seguenti:

  - Classi modificate da Exchange 2013 CU7

  - Attributi aggiunti da Exchange 2013 CU7

## Classi modificate da Exchange 2013 CU7

In questa sezione contiene le classi modificate in Exchange 2013 CU7.
...
<tr class="even">
<td><p>Group</p></td>
<td><p>aggiungere: auxiliaryClass</p></td>
...
In questa sezione contiene gli attributi aggiunti in Exchange 2013 CU7.

  - ms-Exch-Multi-GUID cassetta postale

  - ms-Exch-Sts-Refresh-Tokens-Valid-From

  - ms-Exch-Multi-Mailbox-Locations-Link

## Modifiche dello schema Active Directory di Exchange 2013 aggiornamento cumulativo 6

In questa sezione vengono riepilogate le modifiche apportate allo schema Active Directory quando si installa Exchange 2013 aggiornamento cumulativo 6. In questa sezione sono inclusi nelle sottosezioni seguenti:

  - Classi modificate da aggiornamento cumulativo 6 di Exchange 2013

  - Attributi aggiunti da aggiornamento cumulativo 6 di Exchange 2013

  - Attributi modificati da aggiornamento cumulativo 6 di Exchange 2013

## Classi modificate da aggiornamento cumulativo 6 di Exchange 2013

In questa sezione contiene le classi modificate in Exchange 2013 aggiornamento cumulativo 6.
...
In questa sezione contiene gli attributi aggiunti in Exchange 2013 aggiornamento cumulativo 6.
...
In questa sezione contiene gli attributi modificati in Exchange 2013 aggiornamento cumulativo 6.
...
<tbody>
<tr class="odd">
<td><p>ms-Exch-Smtp--certificato TLS</p></td>
<td><p>sostituire: rangeUpper</p></td>
<td><p>1024</p></td>
</tr>
</tbody>
</table>
...
## Modifiche allo schema di Active Directory in Exchange 2013 CU5

In questa sezione viene fornito un riepilogo delle modifiche apportate allo schema di Active Directory durante l'installazione di Exchange 2013 CU5. In questa sezione sono incluse le seguenti sezioni secondarie:
...
## Classi aggiunte da Exchange 2013 CU5

Questa sezione contiene le classi aggiunte in Exchange 2013 CU5.
...
## Attributi aggiunti da Exchange 2013 CU5

Questa sezione contiene gli attributi aggiunti in Exchange 2013 CU5.

  - ms-Exch-UG-Member-Link

  - ms-Exch-UG-Member-BL

## Attributi modificati da Exchange 2013 CU5

Questa sezione contiene gli attributi modificati in Exchange 2013 CU5.
...
## Modifiche allo schema di Active Directory in Exchange 2013 SP1

In questa sezione viene fornito un riepilogo delle modifiche apportate allo schema di Active Directory durante l'installazione di Exchange 2013 Service Pack 1 (SP1). In questa sezione sono incluse le seguenti sezioni secondarie:
...
## Classi aggiunte da Exchange 2013 SP1

Questa sezione contiene le classi aggiunte in Exchange 2013 SP1.
...
## Classi modificate da Exchange 2013 SP1

Questa sezione contiene gli attributi aggiunti in Exchange 2013 SP1.
...
## Attributi aggiunti da Exchange 2013 SP1
...
## Attributi del catalogo globale aggiunti da Exchange 2013 SP1

I seguenti attributi del catalogo globale vengono aggiunti da Exchange 2013 SP1:

  - ms-Exch-Mailbox-Container-Guid

  - ms-Exch-Unified-Mailbox

## Attributi modificati da Exchange 2013 SP1

Questa sezione contiene gli attributi modificati in Exchange 2013 SP1.
...
## Modifiche allo schema di Active Directory in Exchange 2013 CU3

In questa sezione viene fornito un riepilogo delle modifiche apportate allo schema di Active Directory durante l'installazione di Exchange 2013 CU3. In questa sezione sono incluse le seguenti sezioni secondarie:
...
## Classi aggiunte da Exchange 2013 CU3

Questa sezione contiene le classi aggiunte in Exchange 2013 CU3.
...
## Attributi aggiunti da Exchange 2013 CU3

Questa sezione contiene gli attributi aggiunti in Exchange 2013 CU3.

  - ms-Exch-Encryption-Throttling-Policy-State-Ex

## Attributi modificati da Exchange 2013 CU3

Questa sezione contiene gli attributi modificati in Exchange 2013 CU3.
...
## Modifiche allo schema di Active Directory in Exchange 2013 CU2

In questa sezione viene fornito un riepilogo delle modifiche apportate allo schema di Active Directory durante l'installazione di Exchange 2013 CU2. In questa sezione sono incluse le seguenti sezioni secondarie:
...
## Classi aggiunte da Exchange 2013 CU2

Questa sezione contiene le classi aggiunte in Exchange 2013 CU2.
...
## Classi modificate da Exchange 2013 CU2

Questa sezione contiene le classi modificate in Exchange 2013 CU2.
...
## Attributi aggiunti da Exchange 2013 CU2

Questa sezione contiene gli attributi aggiunti in Exchange 2013 CU2.

  - ms-Exch-Tenant-Country

## Attributi modificati da Exchange 2013 CU2

Questa sezione contiene gli attributi modificati in Exchange 2013 CU2.
...
## ID oggetti aggiunti da Exchange 2013 CU2

Quando si installa Exchange 2013 CU1, vengono aggiunti i seguenti ID oggetti classe:

  - 1.2.840.113556.1.5.7000.62.50204

  - 1.2.840.113556.1.5.7000.62.50205

Quando si installa Exchange 2013 CU1, vengono aggiunti i seguenti ID oggetti attributo:

  - 1.2.840.113556.1.4.7000.102.52130

## modifiche dello schema di Active Directory in Exchange 2013 CU1

In questa sezione viene fornito un riepilogo delle modifiche apportate allo schema di Active Directory durante l'installazione di Exchange 2013 CU1. In questa sezione sono incluse le seguenti sezioni secondarie:
...
## Classi modificate da Exchange 2013 CU1

Questa sezione contiene le classi modificate in Exchange 2013 CU1.
...
## Classi aggiunte da Exchange 2013 CU1
...
## Attributi modificati da Exchange 2013 CU1

Questa sezione contiene gli attributi modificati in Exchange 2013 CU1.
...
## ID oggetti aggiunti da Exchange 2013 CU1
...
## Attributi indicizzati aggiunti da Exchange 2013 CU1

Nella seguente tabella sono riportati gli attributi che vengono aggiunti all'elenco di attributi indicizzati durante l'installazione di Exchange 2013 CU1:
...
<tr class="header">
<th>Attributo</th>
<th>Valore del contrassegno di ricerca</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
## Insiemi di proprietà modificate da Exchange 2013 CU1

I seguenti insiemi di proprietà vengono modificati all'installazione di Exchange 2013 CU1:

  - Exchange-Information

## Attributi del catalogo globale aggiunti da Exchange 2013 CU1

I seguenti attributi del catalogo globale vengono aggiunti da Exchange 2013 CU1:
...
## Modifiche allo schema di Active Directory in Exchange 2013 RTM

In questa sezione viene fornito un riepilogo delle modifiche apportate allo schema di Active Directory durante l'installazione di Exchange 2013 RTM. In questa sezione sono incluse le seguenti sezioni secondarie:
...
## Classi modificate da Exchange 2013 RTM

Questa sezione contiene le classi modificate in Exchange 2013 RTM.
...
## Attributi modificati da Exchange 2013 RTM

Questa sezione contiene gli attributi modificati in Exchange 2013 RTM.
...
<td><p>ntdsSchemaAdd</p></td>
<td><p>attributeID: 1.2.840.113556.1.4.7000.102.51992 isMemberOfPartialAttributeSet: FALSE (non nel catalogo globale) searchFlags: 0 (nessun indice)</p></td>
</tr>
<tr class="odd">
...
<td><p>ntdsSchemaAdd</p></td>
<td><p>attributeID: 1.2.840.113556.1.4.7000.102.51990 isMemberOfPartialAttributeSet: FALSE (non nel catalogo globale) searchFlags: 0 (nessun indice)</p></td>
</tr>
<tr class="odd">
...
## Classi aggiunte da Exchange 2013 RTM

Quando si installa Exchange 2013 RTM, vengono aggiunte le seguenti classi:
...
## Attributi aggiunti da Exchange 2013 RTM

I seguenti attributi riguardano un insieme di modifiche necessarie per le nuove funzionalità e vengono aggiunti quando si installa Exchange 2013 RTM:
...
## ID MAPI aggiunti da Exchange 2013 RTM

Quando si installa Exchange 2013 RTM, vengono aggiunti i seguenti ID MAPI:

  - 36066

  - 36067

## Diritti estesi aggiunti da Exchange 2013 RTM

Nella seguente tabella sono elencati i diritti estesi che vengono aggiunti quando si installa Exchange 2013 RTM. L'installazione di Exchange 2013 RTM non modifica i diritti estesi esistenti.
...
<p>displayName: Accetta XProxyFrom</p>
...
## ID oggetti aggiunti da Exchange 2013 RTM

Quando si installa Exchange 2013 RTM, vengono aggiunti i seguenti ID oggetti attributo:
...
Quando si installa Exchange 2013 RTM, vengono aggiunti i seguenti ID oggetti classe:
...
## Attributi indicizzati aggiunti da Exchange 2013 RTM

Nella seguente tabella sono riportati gli attributi che vengono aggiunti all'elenco di attributi indicizzati durante l'installazione di Exchange 2013 RTM:
...
## Attributi del catalogo globale aggiunti da Exchange 2013 RTM

I seguenti attributi del catalogo globale vengono aggiunti da Exchange 2013 RTM:
