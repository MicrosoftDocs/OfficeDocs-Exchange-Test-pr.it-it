---
title: 'Ruolo di directory virtuali di Exchange: Exchange 2013 Help'
TOCTitle: Ruolo di directory virtuali di Exchange
ms:assetid: d10896e9-3574-42bb-9090-61f3abc33005
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876942(v=EXCHG.150)
ms:contentKeyID: 50481744
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di directory virtuali di Exchange
...
Il ruolo di gestione `Exchange Virtual Directories` consente agli amministratori di gestire le directory virtuali di Microsoft Office Outlook Web App, Microsoft ActiveSync, Rubriche fuori rete (OAB), individuazione automatica, Windows PowerShell e dell'interfaccia di amministrazione Web sui singoli server.
