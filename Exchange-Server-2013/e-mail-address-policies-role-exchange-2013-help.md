---
title: 'Ruolo di criteri degli indirizzi di posta elettronica: Exchange 2013 Help'
TOCTitle: Ruolo di criteri degli indirizzi di posta elettronica
ms:assetid: d272e672-81ea-417c-b5d6-76a5efd5c036
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876944(v=EXCHG.150)
ms:contentKeyID: 50481750
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di criteri degli indirizzi di posta elettronica
...
Il ruolo di gestione `E-Mail Address Policies` consente agli amministratori di gestire i criteri degli indirizzi di posta elettronica in un'organizzazione.
