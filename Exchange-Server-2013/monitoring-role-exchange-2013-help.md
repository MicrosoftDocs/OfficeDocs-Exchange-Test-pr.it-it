---
title: 'Ruolo di monitoraggio: Exchange 2013 Help'
TOCTitle: Ruolo di monitoraggio
ms:assetid: ba4cb787-8e17-4565-bccd-74e846c06a4f
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876933(v=EXCHG.150)
ms:contentKeyID: 50481539
ms.date: 05/22/2018
...
Il ruolo di gestione Monitoraggio consente agli amministratori di monitorare i servizi di Exchange e la disponibilità dei componenti in un'organizzazione. Questo ruolo può essere utilizzato anche con gli account di servizio impiegati dalle applicazioni di monitoraggio per raccogliere informazioni sullo stato dei server che eseguono Exchange.
