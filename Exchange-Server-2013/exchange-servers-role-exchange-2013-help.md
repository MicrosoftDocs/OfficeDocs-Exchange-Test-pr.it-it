---
title: 'Ruolo del server di Exchange: Exchange 2013 Help'
TOCTitle: Ruolo del server di Exchange
ms:assetid: 5a626746-8d23-409c-a604-7e565c429990
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876887(v=EXCHG.150)
ms:contentKeyID: 50480672
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo del server di Exchange
...
Il ruolo di gestione `Exchange Servers` consente agli amministratori di effettuare quanto segue sui singoli server:

  - Aggiungere e rimuovere i gruppi di disponibilità del database e configurare le copie del database

  - Abilitare, disabilitare e configurare i servizi di messaggistica unificata

  - Modificare la configurazione di trasporto sui server Accesso client e Cassette postali

  - Abilitare e disabilitare Microsoft Outlook Anywhere sui server Accesso client

  - Modificare la configurazione dei server Accesso client e Cassette postali

  - Modificare la configurazione di Outlook Anywhere sui server Accesso client

  - Modificare la configurazione del filtro dei contenuti sui server Cassette postali

  - Modificare la configurazione generale del server Exchange

  - Modificare la configurazione del monitoraggio dei server

  - Visualizzare la configurazione per ogni ruolo del server
