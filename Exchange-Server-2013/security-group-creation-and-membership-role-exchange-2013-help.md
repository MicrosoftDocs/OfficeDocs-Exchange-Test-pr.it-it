...
ms:contentKeyID: 50480185
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# La creazione del gruppo di sicurezza e l'appartenenza al ruolo
...
Il ruolo di gestione `Security Group Creation and Membership` consente agli amministratori di creare e gestire i gruppi di protezione universale e le relative appartenenze a un'organizzazione.

Se l'organizzazione utilizza un modello di suddivisione delle autorizzazioni con controllo degli accessi basato sui ruoli in cui la creazione e la gestione dei gruppi di sicurezza universale sono eseguite da un gruppo diverso dai gruppi che gestiscono i server su cui è installato Exchange, assegnare questo ruolo a quel gruppo.

Se nell'organizzazione è abilitata la suddivisione delle autorizzazioni per Active Directory, tutte le assegnazioni dei ruoli di gestione senza delega a questo ruolo di gestione sono state rimosse. Se la divisione delle autorizzazioni di Active Directory è abilitata, solo gli amministratori di Active Directory che utilizzano gli strumenti di gestione di Active Directory possono creare nuove entità di sicurezza quali, ad esempio, utenti e gruppi di protezione.

Per ulteriori informazioni, vedere [Informazioni sulle autorizzazioni diviso](understanding-split-permissions-exchange-2013-help.md).
