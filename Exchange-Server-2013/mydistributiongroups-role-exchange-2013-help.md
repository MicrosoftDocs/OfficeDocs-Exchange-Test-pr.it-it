---
title: 'Ruolo MyDistributionGroups: Exchange 2013 Help'
TOCTitle: Ruolo MyDistributionGroups
ms:assetid: 0d23dec0-3832-43bb-bc89-e01408acd0e8
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876849(v=EXCHG.150)
ms:contentKeyID: 50480016
ms.date: 05/22/2018
...
Il ruolo di gestione `MyDistributionGroups` consente ai singoli utenti di creare, modificare e visualizzare gruppi di distribuzione e di modificare, visualizzare, rimuovere e aggiungere membri ai gruppi di distribuzione di cui sono proprietari.
