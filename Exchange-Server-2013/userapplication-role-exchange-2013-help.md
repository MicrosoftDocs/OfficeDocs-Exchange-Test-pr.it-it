---
title: 'Ruolo UserApplication: Exchange 2013 Help'
TOCTitle: Ruolo UserApplication
ms:assetid: a4621e45-53db-42f7-a5d7-c1900a154b4e
ms:mtpsurl: https://technet.microsoft.com/it-it/library/JJ657476(v=EXCHG.150)
ms:contentKeyID: 50481317
ms.date: 05/22/2018
...
Il ruolo di gestione `UserApplication` consente alle applicazioni partner di agire per conto degli utenti finali.
