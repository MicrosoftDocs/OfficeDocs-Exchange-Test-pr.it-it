---
title: 'Ruolo di agenti di estensione cmdlet: Exchange 2013 Help'
TOCTitle: Ruolo di agenti di estensione cmdlet
ms:assetid: 20f9f7c2-a8e5-468e-b1a8-c87c562a2be7
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876857(v=EXCHG.150)
ms:contentKeyID: 50480214
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di agenti di estensione cmdlet
...
Il ruolo di gestione `Cmdlet Extension Agents` consente agli amministratori di abilitare, disabilitare e impostare la priorità degli agenti di estensione cmdlet in un'organizzazione.
