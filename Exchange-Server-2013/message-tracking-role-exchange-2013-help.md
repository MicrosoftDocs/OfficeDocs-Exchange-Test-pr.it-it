---
title: 'Ruolo di verifica messaggi: Exchange 2013 Help'
TOCTitle: Ruolo di verifica messaggi
ms:assetid: 21f18ccd-9b7d-461b-b77c-443d15696d79
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876858(v=EXCHG.150)
ms:contentKeyID: 50480153
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di verifica messaggi
...
Il ruolo di gestione `Message Tracking` consente agli amministratori di tracciare i messaggi in un'organizzazione.
