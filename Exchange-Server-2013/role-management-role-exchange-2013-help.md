---
title: 'Ruolo di gestione ruoli: Exchange 2013 Help'
TOCTitle: Ruolo di gestione ruoli
ms:assetid: 71d8553c-150d-4306-8de0-89be6efb5e40
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876906(v=EXCHG.150)
ms:contentKeyID: 50480974
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di gestione ruoli
...
Il ruolo di gestione `Role Management` consente agli amministratori di gestire, all'interno dell'organizzazione, gruppi di ruoli di gestione, criteri di assegnazione di ruoli e ruoli di gestione, nonché voci, assegnazioni e ambiti di ruolo.

Gli utenti assegnati a questo ruolo possono sovrascrivere il gruppo di ruoli gestito dalla proprietà, configurare qualsiasi gruppo di ruoli e aggiungere o rimuovere i membri desiderati da un qualsiasi gruppo di ruoli.
