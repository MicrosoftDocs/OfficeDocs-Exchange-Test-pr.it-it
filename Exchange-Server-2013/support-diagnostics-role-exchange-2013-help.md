---
title: 'Ruolo Support Diagnostics: Exchange 2013 Help'
TOCTitle: Ruolo Support Diagnostics
ms:assetid: 3ad2c628-019e-4eb7-af43-64ab2a3a2fbf
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876875(v=EXCHG.150)
ms:contentKeyID: 50480376
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo Support Diagnostics
...
Il ruolo di gestione `Support Diagnostics` consente agli amministratori, all'interno di un'organizzazione, di eseguire operazioni avanzate di diagnostica guidati dal Servizio assistenza e supporto tecnico Microsoft.


> [!WARNING]
> Tale ruolo assegna le autorizzazioni cmdlet e script, il cui utilizzo è opportuno avvenga esclusivamente sotto la guida del servizio di assistenza e di supporto tecnico.
