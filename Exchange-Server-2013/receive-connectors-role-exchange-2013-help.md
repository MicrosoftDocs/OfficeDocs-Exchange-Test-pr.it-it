---
title: 'Ruolo connettori di ricezione: Exchange 2013 Help'
TOCTitle: Ruolo connettori di ricezione
ms:assetid: a7c5a086-5066-4ece-9b22-cc1048d2f2bc
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876927(v=EXCHG.150)
ms:contentKeyID: 50481338
ms.date: 05/22/2018
...
Il ruolo di gestione `Receive Connectors` consente agli amministratori di gestire la configurazione del connettore di ricezione di trasporto, ad esempio i limiti di dimensione su un singolo server.
