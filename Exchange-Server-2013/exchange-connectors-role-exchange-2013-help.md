---
title: 'Ruolo connettori di Exchange: Exchange 2013 Help'
TOCTitle: Ruolo connettori di Exchange
ms:assetid: 73f98c82-bde0-443d-9bcf-274047e84e15
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876908(v=EXCHG.150)
ms:contentKeyID: 50480891
ms.date: 05/22/2018
...
Il ruolo di gestione `Exchange Connectors` consente agli amministratori di creare, modificare, visualizzare e rimuovere i connettori dell'agente di recapito.

Questo ruolo non può essere utilizzato per gestire i connettori di invio e di ricezione. Per gestire questi connettori, utilizzare i ruoli relativi ai connettori di invio e ai connettori di ricezione. Per ulteriori informazioni, vedere:
