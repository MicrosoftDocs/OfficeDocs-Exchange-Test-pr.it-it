---
title: 'Ruolo di suggerimenti di posta: Exchange 2013 Help'
TOCTitle: Ruolo di suggerimenti di posta
ms:assetid: 74495ded-6097-4f10-a829-c8ed81f5ba3e
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876909(v=EXCHG.150)
ms:contentKeyID: 50480894
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di suggerimenti di posta
...
Il ruolo di gestione Suggerimenti messaggio consente agli amministratori di gestire i suggerimenti per i messaggi in un'organizzazione.
