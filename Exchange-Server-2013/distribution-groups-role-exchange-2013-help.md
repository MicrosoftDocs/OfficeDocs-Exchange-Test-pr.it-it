---
title: 'Ruolo di gruppi di distribuzione: Exchange 2013 Help'
TOCTitle: Ruolo di gruppi di distribuzione
ms:assetid: 0c3667b6-529b-4bb2-85bf-e24fae82d082
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876848(v=EXCHG.150)
ms:contentKeyID: 50479980
ms.date: 05/22/2018
...
Il ruolo di gestione `Distribution Groups` consente agli amministratori di creare, modificare, visualizzare e rimuovere gruppi di distribuzione e di aggiungere o rimuovere i membri dei gruppi di distribuzione in un'organizzazione.
