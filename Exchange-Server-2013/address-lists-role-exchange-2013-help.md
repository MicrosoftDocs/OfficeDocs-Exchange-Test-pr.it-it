---
title: 'Ruolo di elenchi indirizzi: Exchange 2013 Help'
TOCTitle: Ruolo di elenchi indirizzi
ms:assetid: 31143e30-16f5-45f5-b9a6-a39e6aa831d9
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876867(v=EXCHG.150)
ms:contentKeyID: 50480365
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di elenchi indirizzi
...
Il ruolo di gestione `Address Lists` consente agli amministratori di creare, modificare, visualizzare e rimuovere elenchi di indirizzi, elenchi indirizzi globali ed elenchi di indirizzi offline in un'organizzazione.
