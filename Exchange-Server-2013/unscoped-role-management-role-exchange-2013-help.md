---
title: 'Ruolo senza ambito di gestione dei ruoli: Exchange 2013 Help'
TOCTitle: Ruolo senza ambito di gestione dei ruoli
ms:assetid: d11eb843-64c9-4968-bfd5-9a8d94903058
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876943(v=EXCHG.150)
ms:contentKeyID: 50481745
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo senza ambito di gestione dei ruoli
