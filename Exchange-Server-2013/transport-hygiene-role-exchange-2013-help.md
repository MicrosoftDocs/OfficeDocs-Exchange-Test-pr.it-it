---
title: 'Ruolo igiene di trasporto: Exchange 2013 Help'
TOCTitle: Ruolo igiene di trasporto
ms:assetid: 629792e4-7a8f-4447-b031-1c7d7c994b8a
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876893(v=EXCHG.150)
ms:contentKeyID: 50480801
ms.date: 05/22/2018
...
Il ruolo di gestione `Transport Hygiene` consente agli amministratori di gestire le funzionalità di protezione dalla posta indesiderata e antimalware all'interno di un'organizzazione.
