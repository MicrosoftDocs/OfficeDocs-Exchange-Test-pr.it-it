---
title: 'Ruolo ApplicationImpersonation: Exchange 2013 Help'
TOCTitle: Ruolo ApplicationImpersonation
ms:assetid: d6e43a2f-9b1f-463e-8c56-ca38d9127a5a
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd776119(v=EXCHG.150)
ms:contentKeyID: 50481787
ms.date: 05/22/2018
...
Ad esempio, potrebbe venire visualizzato questi ruoli in Interfaccia di amministrazione di Exchange:
...
> [!IMPORTANT]
> Un processo o un'applicazione membro del ruolo <CODE>ApplicationImpersonation</CODE> può accedere al contenuto della cassetta posta di un utente e agire per conto di tale utente, anche se l'account dell'utente è disabilitato. Ciò potrebbe consentire agli utenti di accedere alle proprie cassette postali se si dispone di applicazioni, ad esempio Blackberry Enterprise Server, che utilizzano il ruolo <CODE>ApplicationImpersonation</CODE>. I prodotti di terze parti che non utilizzano il ruolo <CODE>ApplicationImpersonation</CODE> e usano invece Exchange ActiveSync non possono accedere a una cassetta postale dopo che il relativo account utente è stato disabilitato.<BR>Per evitare che un'applicazione che utilizza il ruolo <CODE>ApplicationImpersonation</CODE> acceda a una cassetta postale o esegua attività per suo conto dopo la disabilitazione del relativo account utente, effettuare una o più delle seguenti operazioni: 
> <UL>
> <LI>
> <P>Disabilitare o rimuovere l'utente nell'applicazione di terzi.</P>
> <LI>
> <P>Eliminare la cassetta postale.</P></LI></UL>
