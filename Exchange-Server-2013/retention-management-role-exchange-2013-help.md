---
title: 'Ruolo di gestione di conservazione: Exchange 2013 Help'
TOCTitle: Ruolo di gestione di conservazione
ms:assetid: ef16b495-c424-4ded-b5da-304e69ce31bb
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876953(v=EXCHG.150)
ms:contentKeyID: 50481981
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di gestione di conservazione
...
Il ruolo di gestione `Retention Management` consente agli amministratori di gestire i criteri di conservazione in un'organizzazione.
