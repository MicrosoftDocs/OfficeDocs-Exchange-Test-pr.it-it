---
title: 'Ruolo di cartelle pubbliche abilitate alla posta: Exchange 2013 Help'
TOCTitle: Ruolo di cartelle pubbliche abilitate alla posta
ms:assetid: 22289ae1-f9e8-4c98-aaad-ee623e05eadd
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876859(v=EXCHG.150)
ms:contentKeyID: 50480221
ms.date: 05/22/2018
...
Il ruolo di gestione `Mail Enabled Public Folders` consente agli amministratori di stabilire se le singole cartelle pubbliche di un'organizzazione sono abilitate o disabilitate alla posta.

Questo ruolo consente di gestire solo le proprietà di posta elettronica delle cartelle pubbliche, ma non consente di gestire le proprietà delle cartelle pubbliche non relative alla posta elettronica. Per gestire le proprietà delle cartelle pubbliche non relative alla posta elettronica, utilizzare il ruolo `Public Folders`. Per ulteriori informazioni, vedere [Ruolo Cartelle pubbliche](public-folders-role-exchange-2013-help.md).
