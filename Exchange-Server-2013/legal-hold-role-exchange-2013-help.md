---
title: 'Ruolo di conservazione legale: Exchange 2013 Help'
TOCTitle: Ruolo di conservazione legale
ms:assetid: c98ce8ca-3477-479a-ad23-a8e6459bc4d0
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876939(v=EXCHG.150)
ms:contentKeyID: 50481682
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di conservazione legale
...
Il ruolo di gestione `Legal Hold` consente agli amministratori di stabilire se i dati in una cassetta postale devono essere conservati per ragioni di gestione delle controversie in un'organizzazione.
