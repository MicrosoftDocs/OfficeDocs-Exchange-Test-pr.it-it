---
title: "Ruolo di impostazioni di trasporto dell'organizzazione: Exchange 2013 Help"
TOCTitle: Ruolo di impostazioni di trasporto dell'organizzazione
ms:assetid: ff4d032e-1b97-4a9d-b479-9b0d61832221
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876961(v=EXCHG.150)
ms:contentKeyID: 50482104
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di impostazioni di trasporto dell'organizzazione
...
Il ruolo di gestione `Organization Transport Settings` consente agli amministratori di gestire le impostazioni di trasporto dell'organizzazione, ad esempio i messaggi di sistema, la configurazione del sito Active Directory e le impostazioni di configurazione del trasporto per l'intera organizzazione Exchange.

Questo ruolo non consente all'utente di creare o gestire connettori di invio o ricezione, code, elementi Hygiene, agenti, domini accettati e remoti o regole. Per creare o gestire le funzionalità di trasporto, è necessario disporre di almeno uno dei seguenti ruoli:
