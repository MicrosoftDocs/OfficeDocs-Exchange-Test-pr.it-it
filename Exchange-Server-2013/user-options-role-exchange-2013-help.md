---
title: 'Ruolo di opzioni utente: Exchange 2013 Help'
TOCTitle: Ruolo di opzioni utente
ms:assetid: fb4d58f5-cc62-4ce8-b2e4-c3cc91795a12
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876960(v=EXCHG.150)
ms:contentKeyID: 50482120
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di opzioni utente
...
Il ruolo di gestione `User Options` consente agli amministratori di visualizzare le opzioni di Outlook Web App di un utente all'interno di un'organizzazione. Questo ruolo può essere utilizzato per facilitare la diagnosi di problemi di configurazione.
