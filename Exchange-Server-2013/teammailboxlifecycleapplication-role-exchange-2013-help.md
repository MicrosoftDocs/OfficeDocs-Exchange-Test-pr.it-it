---
title: 'Ruolo TeamMailboxLifecycleApplication: Exchange 2013 Help'
TOCTitle: Ruolo TeamMailboxLifecycleApplication
ms:assetid: 3cd2cd6f-65e1-4e66-a017-054060c46fe1
ms:mtpsurl: https://technet.microsoft.com/it-it/library/JJ673057(v=EXCHG.150)
ms:contentKeyID: 50480449
ms.date: 05/22/2018
...
Il ruolo di gestione `TeamMailboxLifecycleApplication` consente alle applicazioni dei partner di aggiornare lo stato del ciclo di vita delle cassette postali del sito.
