---
title: 'Ruolo registri di controllo: Exchange 2013 Help'
TOCTitle: Ruolo registri di controllo
ms:assetid: 36a7d375-76f8-441c-9da1-8a50dbd062f1
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876870(v=EXCHG.150)
ms:contentKeyID: 50480413
ms.date: 05/22/2018
...
Il ruolo di gestione `Audit Logs` consente agli amministratori di configurare il registro di controllo dell'amministratore in un'organizzazione.
