---
title: 'Ruolo di ricerca di cassette postali: Exchange 2013 Help'
TOCTitle: Ruolo di ricerca di cassette postali
ms:assetid: f86b63ba-0c67-4748-8965-0c08a6a8aec1
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876958(v=EXCHG.150)
ms:contentKeyID: 50482107
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di ricerca di cassette postali
...
Il ruolo di gestione `Mailbox Search` consente agli amministratori di eseguire ricerche di contenuto in una o più cassette postali di un'organizzazione.
