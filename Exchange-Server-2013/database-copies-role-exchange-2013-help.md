---
title: 'Ruolo delle copie del database: Exchange 2013 Help'
TOCTitle: Ruolo delle copie del database
ms:assetid: 71a95f5b-1f75-4ae9-9ee9-515c3a19d394
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876905(v=EXCHG.150)
ms:contentKeyID: 50480868
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo delle copie del database
...
Il ruolo di gestione `Database Copies` consente agli amministratori di aggiungere, rimuovere, sospendere, ripristinare, visualizzare e aggiornare copie di database sui singoli server.
...
Per utilizzare i cmdlet **Set-MailboxDatabaseCopy** e **Remove-MailboxDatabaseCopy**, inclusi con questo ruolo, è necessario che il database che si desidera configurare o rimuovere si trovi nell'ambito dei database e che sia su un server che si trova nell'ambito dei server. Per ulteriori informazioni sugli ambiti, vedere [Comprensione degli ambiti di gestione dei ruoli](understanding-management-role-scopes-exchange-2013-help.md).
