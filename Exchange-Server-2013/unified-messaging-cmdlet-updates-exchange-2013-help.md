---
title: 'Aggiornamenti del cmdlet messaggistica unificati: Exchange 2013 Help'
TOCTitle: Aggiornamenti del cmdlet messaggistica unificati
ms:assetid: a42c6643-67ed-4003-854a-ac1d66efb965
ms:mtpsurl: https://technet.microsoft.com/it-it/library/JJ150557(v=EXCHG.150)
ms:contentKeyID: 50481356
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Aggiornamenti del cmdlet messaggistica unificati
...
## Parametri aggiornati e nuovi cmdlet di messaggistica unificata

Di seguito è riportato un elenco dei parametri aggiornati e dei nuovi cmdlet di Exchange 2013.
...
> [!NOTE]
> Questo cmdlet funziona solo con i server Messaggistica unificata di Exchange 2007 e 2010.
...
Per i dettagli su tutti i cmdlet di messaggistica unificata, vedere [Cmdlet di messaggistica unificata](https://technet.microsoft.com/it-it/library/aa997665\(v=exchg.150\)).
