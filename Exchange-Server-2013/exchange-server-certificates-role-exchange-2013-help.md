---
title: 'Ruolo dei certificati di Exchange Server: Exchange 2013 Help'
TOCTitle: Ruolo dei certificati di Exchange Server
ms:assetid: fffec840-6c7d-4958-905e-edc4bc060d52
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876963(v=EXCHG.150)
ms:contentKeyID: 50482139
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo dei certificati di Exchange Server
...
Il ruolo di gestione di `Exchange Server Certificates` consente agli amministratori di creare, importare, esportare e gestire i certificati del server Exchange sui singoli server.
