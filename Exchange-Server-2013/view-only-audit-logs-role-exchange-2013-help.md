---
title: 'Ruolo registri di controllo sola visualizzazione: Exchange 2013 Help'
TOCTitle: Ruolo registri di controllo sola visualizzazione
ms:assetid: 9298fe59-0a16-4a09-bdb8-514d1cea6e2f
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Ff461933(v=EXCHG.150)
ms:contentKeyID: 50481185
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo registri di controllo sola visualizzazione
...
Il ruolo di gestione `View-Only Audit Logs` consente agli amministratori o ad utenti esperti di cercare i registro di controllo dell'amministratore in un'organizzazione.
