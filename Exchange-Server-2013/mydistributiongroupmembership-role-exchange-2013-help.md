---
title: 'Ruolo MyDistributionGroupMembership: Exchange 2013 Help'
TOCTitle: Ruolo MyDistributionGroupMembership
ms:assetid: 6b288a4b-f717-4885-9c03-212de465161e
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876900(v=EXCHG.150)
ms:contentKeyID: 50480826
ms.date: 05/22/2018
...
Il ruolo di gestione `MyDistributionGroupMembership` consente ai singoli utenti di visualizzare e modificare l'appartenenza ai gruppi di distribuzione in un'organizzazione, purché tali gruppi di distribuzione permettano la manipolazione dell'appartenenza al gruppo.
