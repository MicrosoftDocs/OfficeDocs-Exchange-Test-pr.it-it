---
title: 'Ruolo i gruppi di disponibilità del database: Exchange 2013 Help'
TOCTitle: Ruolo i gruppi di disponibilità del database
ms:assetid: 0b3e0f7a-21e5-4209-8d5b-b63c6b9de3cc
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876847(v=EXCHG.150)
ms:contentKeyID: 50480000
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo i gruppi di disponibilità del database
