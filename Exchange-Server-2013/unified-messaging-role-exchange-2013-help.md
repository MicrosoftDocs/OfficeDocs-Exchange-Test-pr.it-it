---
title: 'Ruolo Messaggistica unificata: Exchange 2013 Help'
TOCTitle: Ruolo Messaggistica unificata
ms:assetid: bf24aa04-5843-4cf3-83e7-3a5fa7bd3522
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876935(v=EXCHG.150)
ms:contentKeyID: 50481554
ms.date: 05/22/2018
...
Il ruolo `Unified Messaging` consente agli amministratori di gestire i servizi Messaggistica unificata in un'organizzazione.

Questo ruolo non consente all'utente di gestire la configurazione della cassetta postale specifica di messaggistica unificata o i prompt di messaggistica unificata. Per gestire la configurazione della specifica cassetta postale di messaggistica unificata, utilizzare i ruoli associati al ruolo `UM Mailboxes `. Per gestire i prompt di messaggistica unificata, utilizzare i ruoli associati al ruolo `UM Prompts`. Per ulteriori informazioni, vedere:
