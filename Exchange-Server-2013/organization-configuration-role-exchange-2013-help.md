---
title: "Ruolo di configurazione dell'organizzazione: Exchange 2013 Help"
TOCTitle: Ruolo di configurazione dell'organizzazione
ms:assetid: db952cc5-ef70-4366-acbb-0e292d4cbdd0
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dd876946(v=EXCHG.150)
ms:contentKeyID: 50481831
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Ruolo di configurazione dell'organizzazione
...
Il ruolo di gestione `Organization Configuration` consente agli amministratori di gestire le impostazioni a livello di organizzazione. La configurazione dell'organizzazione che può essere controllata con questo ruolo include, tra le altre cose:
  ...
  - Se i suggerimenti messaggio sono abilitati o disabilitati per l'organizzazione

  - URL della home page per la cartella gestita

  - Indirizzo SMTP e indirizzi di posta elettronica alternativi del destinatario di Microsoft Exchange

  - Configurazione dello schema delle proprietà della cassetta postale per le risorse

  - URL della Guida per l'interfaccia di amministrazione di Exchange e Microsoft Office Outlook Web App

Questo tipo di ruolo non include le autorizzazioni incluse nei ruoli `Organization Client Access` o `Organization Transport Settings`.
