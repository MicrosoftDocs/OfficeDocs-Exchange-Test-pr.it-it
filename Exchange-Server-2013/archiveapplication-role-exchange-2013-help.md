---
title: 'Ruolo ArchiveApplication: Exchange 2013 Help'
TOCTitle: Ruolo ArchiveApplication
ms:assetid: 22d673cf-d3a3-43f0-be1e-e4fc74546e64
ms:mtpsurl: https://technet.microsoft.com/it-it/library/JJ673046(v=EXCHG.150)
ms:contentKeyID: 50480226
ms.date: 05/22/2018
...
Il ruolo di gestione `ArchiveApplication` consente alle applicazioni dei partner di archiviare gli elementi nelle cassette postali degli utenti.
