...
ms:mtpsurl: https://technet.microsoft.com/it-it/library/Dn198286(v=EXCHG.150)
ms:contentKeyID: 54651652
ms.date: 08/30/2014
...
This topic contains the procedures that you can use as a reference when managing the Exchange Server 2013 Management Pack. For procedures related to deployment, see [Procedure relative alla distribuzione](procedures-related-to-deployment.md).
...
![Disabilitazione di un avviso nella console ](images/Dn198286.1c4f15b5-4978-4442-b26b-cc65ba577c9c(EXCHG.150).png "Disabilitazione di un avviso nella console ")
...
See the following topics for more information about the cmdlets you can use to configure monitoring overrides.
  ...
  - [Get-MonitoringItemIdentity](https://technet.microsoft.com/it-it/library/jj218668\(v=exchg.150\))
